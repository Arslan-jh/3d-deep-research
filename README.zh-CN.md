...
![3D Deep Research 工作流](media/3d-deep-research-flow.svg)
...
仓库是单一 Skill；公开 README 放在 Skill 目录之外。
...
同一个 `3d-deep-research/` Skill 目录也可以复制到其他 Agent Skills 兼容运行时，但应先确认目标运行时的安装路径。
...
- [可编辑流程架构图](media/3d-deep-research-flow.excalidraw)
